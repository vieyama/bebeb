...
class _MainScreensState extends State<MainScreens> {
  ...
  Future<dynamic> sendMotivasi(String isi) async {
    ...
    try {
      Response response = await dio.post(
          "https://vigenesia.org/api/dev/POSTmotivasi",
          data: body,
          options: Options(
              contentType: Headers
  ...
  Future<List<MotivasiModel>> getData() async {
    var response = await dio.get(
        'https://vigenesia.org/api/Get_motivasi?iduser=${widget.iduser}'); // NGambil by data
    print(" ${response.data}");
  ...
  Future<dynamic> deletePost(String id) async {
    ...
    var response = await dio.delete(
        'https://vigenesia.org/api/dev/DELETEmotivasi',
        data: data,
        options: Options(
  ...
  Future<List<MotivasiModel>> getData2() async {
    var response = await dio
        .get('https://vigenesia.org/api/Get_motivasi'); // Ngambil by ALL USER
    print(" ${response.data}");
    if (response.statusCode == 200) {
      var getUsersData = response.data as List;
      var listUsers =
